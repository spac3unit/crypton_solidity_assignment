...
const web3 = new Web3 (new Web3.providers.HttpProvider(process.env.PROVIDER_URL || "http://127.0.0.1:8545/"));
const DonationContract = new web3.eth.Contract(abi, process.env.CONTRACT_ADDRESS || "0x5FbDB2315678afecb367f032d93F642f64180aa3");
...
task("withdraw", "Wiwthdraw some amount of funds") // npx hardhat withdraw
    .setAction(async (taskArgs) => {
        await DonationContract.methods.withdraw("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266", 300).send({from:"0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266"})
...
task("donatedByAddress", "donated by specific address") // npx hardhat donatedByAddress
    .setAction(async (taskArgs) => {
        await DonationContract.methods.donatedByAddress("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266")
